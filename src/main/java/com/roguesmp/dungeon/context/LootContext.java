...
import com.roguesmp.dungeon.loot.LootRule;
...
public class LootContext {
    ...
    private final @NotNull List<LootRule> rules;
    ...
    public @NotNull List<LootRule> getRules() {
        return rules;
    }
    ...
    public static Builder builder(@NotNull SmpPlayer player) {
    ...
    public static class Builder {
        ...
        public Builder player(@NotNull SmpPlayer player) {
            this.player = player;
            return this;
        }

        public Builder addRule(@NotNull LootRule rule) {
            this.rules.add(rule);
            return this;
        }

        public Builder addRules(@NotNull List<LootRule> rules) {
