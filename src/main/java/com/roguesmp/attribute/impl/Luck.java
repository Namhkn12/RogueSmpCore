...
public class Luck implements SmpAttribute {
    public static final NamespacedKey MODIFIER_ID = new NamespacedKey("smp", "luck");

    @Override public @NotNull String getId() { return "luck"; }
    @Override public @NotNull Attributes getEnumConstant() { return Attributes.LUCK; }
    @Override public @NotNull String getSimpleName() { return "May mắn"; }

    @Override
    public void addVanillaAttribute(Player player, double value) {
        AttributeInstance ai = player.getAttribute(Attribute.LUCK);
        if (ai != null) {
