...
public class SubmergedMiningSpeed implements SmpAttribute {
    public static final NamespacedKey MODIFIER_ID = new NamespacedKey("smp", "submerged_mining_speed");

    @Override public @NotNull String getId() { return "submerged_mining_speed"; }
    @Override public @NotNull Attributes getEnumConstant() { return Attributes.SUBMERGED_MINING_SPEED; }
    @Override public @NotNull String getSimpleName() { return "Tốc độ đào dưới nước"; }

    @Override
    public void addVanillaAttribute(Player player, double value) {
        AttributeInstance ai = player.getAttribute(Attribute.SUBMERGED_MINING_SPEED);
        if (ai != null) {
    ...
    public @NotNull String getSimpleDescription() {
        return "Tăng tốc độ đào dưới nước thêm x";
    }
