...
public class EntityReach implements SmpAttribute {
    public static final NamespacedKey MODIFIER_ID = new NamespacedKey("smp", "entity_reach");

    @Override public @NotNull String getId() { return "entity_reach"; }
    @Override public @NotNull Attributes getEnumConstant() { return Attributes.ENTITY_REACH; }
    @Override public @NotNull String getSimpleName() { return "Tầm đánh"; }

    @Override
    public void addVanillaAttribute(Player player, double value) {
        AttributeInstance ai = player.getAttribute(Attribute.ENTITY_INTERACTION_RANGE);
        if (ai != null) {
    ...
    public @NotNull String getSimpleDescription() {
        return "Tăng tầm với khi tấn công kẻ địch thêm x khối";
    }
