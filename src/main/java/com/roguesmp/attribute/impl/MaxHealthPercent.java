...
public class MaxHealthPercent implements SmpAttribute {
    public static final NamespacedKey MODIFIER_ID = new NamespacedKey("smp", "max_health_percent");

    @Override public @NotNull String getId() { return "max_health_percent"; }
    @Override public @NotNull Attributes getEnumConstant() { return Attributes.MAX_HEALTH_PERCENT; }
    @Override public @NotNull String getSimpleName() { return "Máu tối đa"; }
