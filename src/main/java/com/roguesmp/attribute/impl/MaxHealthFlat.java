...
public class MaxHealthFlat implements SmpAttribute {
    public static final NamespacedKey MODIFIER_ID = new NamespacedKey("smp", "max_health_flat");

    @Override public @NotNull String getId() { return "max_health_flat"; }
    @Override public @NotNull Attributes getEnumConstant() { return Attributes.MAX_HEALTH_FLAT; }
