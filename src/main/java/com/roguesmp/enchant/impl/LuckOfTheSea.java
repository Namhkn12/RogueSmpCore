...
public class LuckOfTheSea implements SmpEnchant {

    @Override public @NotNull String getId() { return "luck_of_the_sea"; }
    @Override public @NotNull Enchants getEnumConstant() { return Enchants.LUCK_OF_THE_SEA; }
    @Override public @NotNull String getSimpleName() { return "May mắn của biển"; }
    ...
    @Override public void attachVanillaEnchant(Map<Enchantment, Integer> vanillaMap, int level) {
        vanillaMap.put(Enchantment.LUCK_OF_THE_SEA, level);
    }
