...
public class Riptide implements SmpEnchant {

    @Override public @NotNull String getId() { return "riptide"; }
    @Override public @NotNull Enchants getEnumConstant() { return Enchants.RIPTIDE; }
    @Override public @NotNull String getSimpleName() { return "Sóng dữ"; }
    ...
    @Override public void attachVanillaEnchant(Map<Enchantment, Integer> vanillaMap, int level) {
        vanillaMap.put(Enchantment.RIPTIDE, level);
    }
}
